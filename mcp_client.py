...
CUSTOM_MCP_PATH = Path(
    r"c:\Users\pauls\OneDrive\Desktop\Multi-Agent-System\custom_weather_mcp_server.py"
)
WEATHER_SERVER_PATH = Path(
    os.getenv(
        ...
        str(
            CUSTOM_MCP_PATH
            if CUSTOM_MCP_PATH.is_file()
            else BASE_DIR / "custom_weather_mcp_server.py"
        ),
    )
)
...
client = MultiServerMCPClient(
    {
        ...
        "weather": {
            ...
            # Uses the project virtualenv or active Python executable.
